...
Item
{
	...
	Item
	{
		...
		Text
		{
			anchors.right: id_message.left;
			color: light_grey;
			font.pixelSize: font_size;
			height: parent.height;
			horizontalAlignment: Text.AlignRight;
			text: Number.fromLocaleString(role_message);
			verticalAlignment: Text.AlignVCenter;		
			width: parent.width - id_name.width - id_message.width;
		}
	}
	...
	MouseArea
	{
		...
		onPressAndHold:
		{
			...
			// Menu
			id_loader.source = "qrc:/qml/menu/EnvelopeMenu.qml";
