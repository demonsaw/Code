...
Rectangle {
    ...
    readonly property real expandedFraction: 0.80  // How big fraction of the screen realesatate that is covered by an open menu
    readonly property real _scaleFactor: _rootItem.width / 360 // Note, this should really be application global
    ...
    readonly property int _openMarginSize: enabled? 50 * _scaleFactor : 0;
    ...
    MouseArea {
        ...
        height: visualParent.height - header_size;
        ...
        drag.onActiveChanged: if (mouse.drag.active) holdAnimation.stop()
