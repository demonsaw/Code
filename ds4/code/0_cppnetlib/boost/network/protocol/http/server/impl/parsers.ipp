...
// EJA: Needed to compile with boost_1_66_0
BOOST_NETWORK_INLINE void parse_version(std::string const& partial_parsed, std::tuple<boost::uint8_t, boost::uint8_t>& version_pair)
{
